...
const Content = (
  <Fragment>
    <div className="u-margin-top-bottom--large">
      <TextBlock>
        <p>
          ...
          Datenschutzerklärung informieren wir Sie insbesondere über Art,
          ...
          anderen über die Zwecke und Mittel der Verarbeitung entscheiden. Zudem
    ...
    <Subheadline text="I. Informationen über uns als Verantwortliche" />
    <div className="u-margin-top-bottom--large">
      <TextBlock>
        <p>
          ...
          01309 Dresden <br />
          Telefon: 0351 449510 <br />
          E-Mail: info@drehauf.com
        </p>
      </TextBlock>
    </div>
    ...
    <div className="u-margin-top-bottom--large">
      <TextBlock>
        <p>
          ...
          Datenverarbeitung haben die Nutzer und Betroffenen das Recht auf
          Bestätigung, ob sie betreffende Daten verarbeitet werden, auf Auskunft
          über die verarbeiteten Daten, auf weitere Informationen über die
          Datenverarbeitung sowie auf Kopien der Daten (vgl. auch Art. 15
          DSGVO);auf Berichtigung oder Vervollständigung unrichtiger bzw.
          unvollständiger Daten (vgl. auch Art. 16 DSGVO);auf unverzügliche
          Löschung der sie betreffenden Daten (vgl. auch Art. 17 DSGVO), oder,
          alternativ, soweit eine weitere Verarbeitung gemäß Art. 17 Abs. 3
          DSGVO erforderlich ist, auf Einschränkung der Verarbeitung nach
          Maßgabe von Art. 18 DSGVO; auf Erhalt der sie betreffenden und von
          ihnen bereitgestellten Daten und auf Übermittlung dieser Daten an
          andere Anbieter/Verantwortliche (vgl. auch Art. 20 DSGVO); auf
          Beschwerde gegenüber der Aufsichtsbehörde, sofern sie der Ansicht
          ...
          Art. 77 DSGVO).Darüber hinaus ist der Anbieter dazu verpflichtet, alle
          Empfänger, denen gegenüber Daten durch den Anbieter offengelegt worden
          sind, über jedwede Berichtigung oder Löschung von Daten oder die
          ...
          Nutzer ein Recht auf Auskunft über diese Empfänger.Ebenfalls haben die
          Nutzer und Betroffenen nach Art. 21 DSGVO das Recht auf Widerspruch
          gegen die künftige Verarbeitung der sie betreffenden Daten, sofern die
          Daten durch den Anbieter nach Maßgabe von Art. 6 Abs. 1 lit. f) DSGVO
          verarbeitet werden. Insbesondere ist ein Widerspruch gegen die
          Datenverarbeitung zum Zwecke der Direktwerbung statthaft.
        </p>
      </TextBlock>
    </div>
    <Subheadline text="III. Informationen zur Datenverarbeitung" />
    <div className="u-margin-top-bottom--large">
      <TextBlock>
        <p>
    ...
    <div className="u-margin-top-bottom--large">
      <TextBlock>
        <p>
          ...
          erfolgt, erhoben. Diese so erhobenen Daten werden vorrübergehend
    ...
    <Subheadline text="Kontaktanfragen / Kontaktmöglichkeit" />
    <div className="u-margin-top-bottom--large">
      <TextBlock>
        <p>
          ...
          beantworten.Rechtsgrundlage für diese Verarbeitung ist Art. 6 Abs. 1
          lit. b) DSGVO.Ihre Daten werden gelöscht, sofern Ihre Anfrage
          abschließend beantwortet worden ist und der Löschung keine
          gesetzlichen Aufbewahrungspflichten entgegenstehen, wie bspw. bei
